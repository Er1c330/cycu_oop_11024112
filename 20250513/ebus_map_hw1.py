...
class taipei_route_info:
    ...
    def _fetch_content(self):
        ...
        try:
            ...
            print("Error occurred while launching Playwright.")
            print("Please ensure Playwright is installed and run the following command:")
